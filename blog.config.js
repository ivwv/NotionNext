...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ivwv', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.ivwv.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, ivwv', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/ivwv', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: [
    'https://public-1310720021.cos.ap-shanghai.myqcloud.com/blog.ivwv.site/script/append.script.js'
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'ivwv/blog-comment', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  ANALYTICS_BAIDU_ID:
    ...
    '386e399ecfc0befca878058f08477f34', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-GVN7FY161T', // 谷歌Analytics的id e.g: G-XXXXXXXXXX

  // 51la 站点统计 https://www.51.la/
  ANALYTICS_51LA_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3GovhAjEi5Ic3T9Y', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK:
    process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3GovhAjEi5Ic3T9Y', // ck，在51la后台获取
